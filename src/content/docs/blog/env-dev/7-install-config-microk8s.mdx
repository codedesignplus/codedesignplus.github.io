...
tags: ["MicroK8s", "Kubernetes", "Tutorial", "Infraestructura", "Homelab", "MetalLB", "DevOps"]
excerpt: "Es hora de construir el motor de nuestra aplicación: un clúster de Kubernetes. En esta guía, te enseñamos a instalar y configurar MicroK8s paso a paso. Descubre cómo habilitar addons esenciales como DNS para el descubrimiento de servicios, MetalLB para exponer tus aplicaciones y Hostpath Storage para la persistencia de datos, dejando tu clúster listo para la acción."
authors:
    - wclg
---
