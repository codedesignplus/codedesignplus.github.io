...
1.  **Verificar los Pods en Lens**
    ...
    <Image src="/images/blogs/ecosystem/ms-rbac/lens-verify-pods.png" alt="Verificando los pods de ms-rbac en Lens" width="2550" height="1314" decoding="async" loading="lazy"/>
