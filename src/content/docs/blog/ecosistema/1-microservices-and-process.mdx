...
En la [primera fase de nuestra serie](/blog/quick-start/14-cierre-fase-infraestructura), construimos meticulosamente el escenario: una plataforma robusta, segura y escalable sobre Kubernetes. Ahora que el escenario está listo, es hora de presentar a los actores principales.
