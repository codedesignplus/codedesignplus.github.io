...
tags: ["RabbitMQ", "Kubernetes", "Operator", "Mensajería", "Event-Driven", "Helm", "Istio"]
excerpt: "Añadimos la columna vertebral de nuestra comunicación asíncrona. Aprende a desplegar un clúster de RabbitMQ usando el Operator de Bitnami y a exponer su UI de gestión de forma segura con Istio."
authors:
    - wclg
---
