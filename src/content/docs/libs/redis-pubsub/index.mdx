...
1. Asignar las opciones de configuración en el `appsettings.json`:
    ...
    ```json url="examples/CodeDesignPlus.Net.Redis.PubSub.Sample/src/CodeDesignPlus.Net.Redis.PubSub.Producer.Sample/appsettings.json"
    ```
...
El proyecto de ejemplo [`CodeDesignPlus.Net.Redis.PubSub.Sample`](https://github.com/codedesignplus/CodeDesignPlus.Net.Sdk/tree/feature/fix-duplicate-key/examples/CodeDesignPlus.Net.Redis.PubSub.Sample) contiene dos ejemplos, uno para productores y otro para consumidores, que ilustran cómo utilizar `CodeDesignPlus.Net.Redis.PubSub` en una aplicación .NET Core.
...
```csharp url="examples/CodeDesignPlus.Net.Redis.PubSub.Sample/src/CodeDesignPlus.Net.Redis.PubSub.Producer.Sample/Program.cs"
```
...
2. Definir la entidad de usuario:
    ...
    ```csharp url="examples/CodeDesignPlus.Net.Redis.PubSub.Sample/src/CodeDesignPlus.Net.Redis.PubSub.Producer.Sample/UserEntity.cs"
    ```
...
3. Creamos los eventos de dominio:
    ...
    ```csharp url="examples/CodeDesignPlus.Net.Redis.PubSub.Sample/src/CodeDesignPlus.Net.Redis.PubSub.Producer.Sample/UserCreatedDomainEvent.cs"
    ```
...
```csharp url="examples/CodeDesignPlus.Net.Redis.PubSub.Sample/src/CodeDesignPlus.Net.Redis.PubSub.Consumer.Sample/Program.cs"
```

<Steps>
1. Configuración de Redis en `appsettings.json`:

    ```json url="examples/CodeDesignPlus.Net.Redis.PubSub.Sample/src/CodeDesignPlus.Net.Redis.PubSub.Consumer.Sample/appsettings.json"
    ```
...
2. Definir la entidad de usuario:
    ...
    ```csharp url="examples/CodeDesignPlus.Net.Redis.PubSub.Sample/src/CodeDesignPlus.Net.Redis.PubSub.Consumer.Sample/UserEntity.cs"
    ```
...
3. Creamos los eventos de dominio:
    ...
    ```csharp url="examples/CodeDesignPlus.Net.Redis.PubSub.Sample/src/CodeDesignPlus.Net.Redis.PubSub.Consumer.Sample/UserCreatedEvent.cs"
    ```
...
4. Creamos el event handler:
    ...
    ```csharp url="examples/CodeDesignPlus.Net.Redis.PubSub.Sample/src/CodeDesignPlus.Net.Redis.PubSub.Consumer.Sample/UserCreatedEventHandler.cs"
    ```
...
- [Repositorio de ejemplos en GitHub](https://github.com/codedesignplus/CodeDesignPlus.Net.Sdk/tree/feature/fix-duplicate-key/examples/CodeDesignPlus.Net.Redis.PubSub.Sample)
