...
- **Servicios**: Gestiona la resolución y la propagación de eventos de dominio a través de la interfaz `IDomainEventResolverService`.
...
- src
    ...
    - CodeDesignPlus.Net.Core.Abstractions
        ...
        - IAggregateRoot.cs
        - IDomainEvent.cs
        - IDomainEventResolverService.cs
        - IDto.cs
        - IEntity.cs
        - IErrorCodes.cs
        - IStartupServices.cs
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddTransient<IDomainEventResolverService, DomainEventResolverService>();
