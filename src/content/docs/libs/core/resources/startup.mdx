...
```csharp url="packages/CodeDesignPlus.Net.Core/src/CodeDesignPlus.Net.Core.Abstractions/IStartup.cs" 
```
...
```csharp url="samples/CodeDesignPlus.Net.Core.Sample/src/CodeDesignPlus.Net.Core.Sample/Resources/Startup/StartupCustom.cs" 
```
