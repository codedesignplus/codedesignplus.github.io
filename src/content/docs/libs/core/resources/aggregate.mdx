...
```csharp url="samples/CodeDesignPlus.Net.Core.Sample/src/CodeDesignPlus.Net.Core.Sample/src/CodeDesignPlus.Net.Core.Sample/Resources/Aggregate/OrderAggregate.cs"
```
