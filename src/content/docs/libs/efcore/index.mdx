...
1. Asignar las opciones de configuración en el `appsettings.json`:
    ...
    ```json url="examples/CodeDesignPlus.Net.EFCore.Sample/src/CodeDesignPlus.Net.EFCore.Sample.RepositoryBase/appsettings.json"
    ```
...
El proyecto de ejemplo [`CodeDesignPlus.Net.EFCore.Sample`](https://github.com/codedesignplus/CodeDesignPlus.Net.Sdk/tree/feature/fix-duplicate-key/examples/CodeDesignPlus.Net.EFCore.Sample) contiene un par de ejemplos exponiendo el uso de `IOperationBase` y `RepositoryBase`.
