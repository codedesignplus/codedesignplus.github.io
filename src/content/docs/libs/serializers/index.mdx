...
1. Creamos el modelo `UserModel`:
    ...
    ```csharp url="samples/CodeDesignPlus.Net.Serializers.Sample/src/CodeDesignPlus.Net.Serializers.Sample/UserModel.cs"
    ```
