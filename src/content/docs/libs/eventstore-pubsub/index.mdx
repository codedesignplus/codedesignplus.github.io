...
1. Asignar las opciones de configuración en el `appsettings.json`:
    ...
    ```json url="samples/CodeDesignPlus.Net.EventStore.PubSub.Sample/src/CodeDesignPlus.Net.EventStore.PubSub.Sample/appsettings.json"
    ```
...
```csharp url="samples/CodeDesignPlus.Net.EventStore.PubSub.Sample/src/CodeDesignPlus.Net.EventStore.PubSub.Sample/Program.cs"
```
...
2. Creación del `OrderAggregate`
    ...
    ```csharp url="samples/CodeDesignPlus.Net.EventStore.PubSub.Sample/src/CodeDesignPlus.Net.EventStore.PubSub.Sample/Aggregates/OrderAggregate.cs"
    ```
...
3. Creación de los eventos de dominio
    ...
    ```csharp url="samples/CodeDesignPlus.Net.EventStore.PubSub.Sample/src/CodeDesignPlus.Net.EventStore.PubSub.Sample/Events/OrderCreatedDomainEvent.cs"
    ``` 
    
    ```csharp url="samples/CodeDesignPlus.Net.EventStore.PubSub.Sample/src/CodeDesignPlus.Net.EventStore.PubSub.Sample/Events/NameUpdatedDomainEvent.cs"
    ``` 
    
    ```csharp url="samples/CodeDesignPlus.Net.EventStore.PubSub.Sample/src/CodeDesignPlus.Net.EventStore.PubSub.Sample/Events/ProductAddedDomainEvent.cs"
    ```
