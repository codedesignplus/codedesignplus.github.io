...
1. Asignar las opciones de configuración en el `appsettings.json`:
    ...
    ```json url="examples/CodeDesignPlus.Net.PubSub.Sample/src/CodeDesignPlus.Net.PubSub.Sample/appsettings.json"
    ```
...
El proyecto de ejemplo [`CodeDesignPlus.Net.PubSub.Sample`](https://github.com/codedesignplus/CodeDesignPlus.Net.Sdk/tree/feature/fix-duplicate-key/examples/CodeDesignPlus.Net.PubSub.Sample) muestra cómo publicar y suscribir eventos de dominio. De igual forma se muestra cómo implementar un broker en memoria para el ejemplo.

```csharp url="examples/CodeDesignPlus.Net.PubSub.Sample/src/CodeDesignPlus.Net.PubSub.Sample/Program.cs"
```
...
1. Creamos la entidad `UserEntity` que sera utilizada en el evento `UserCreatedEvent`.
    ...
    ```csharp url="examples/CodeDesignPlus.Net.PubSub.Sample/src/CodeDesignPlus.Net.PubSub.Sample/Entities/UserEntity.cs"
    ```

2. Creamos el evento `UserCreatedEvent` que hereda de `DomainEvent`.

    ```csharp url="examples/CodeDesignPlus.Net.PubSub.Sample/src/CodeDesignPlus.Net.PubSub.Sample/Handlers/UserCreatedEvent.cs"
    ```
...
4. Creamos el servidor `InMemoryBroker` que implementa `IMessage`. 
    ...
    ```csharp url="examples/CodeDesignPlus.Net.PubSub.Sample/src/CodeDesignPlus.Net.PubSub.Sample/Server/InMemoryBroker.cs"
    ```
...
- [Repositorio de ejemplos en GitHub](https://github.com/codedesignplus/CodeDesignPlus.Net.Sdk/tree/feature/fix-duplicate-key/examples/CodeDesignPlus.Net.PubSub.Sample/src/CodeDesignPlus.Net.PubSub.Sample)
