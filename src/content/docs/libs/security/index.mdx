...
La solución [CodeDesignPlus.Net.Security.Sample](https://github.com/codedesignplus/CodeDesignPlus.Net.Sdk/blob/feature/fix-duplicate-key/samples/CodeDesignPlus.Net.Security.Sample/src/CodeDesignPlus.Net.Security.Sample/Program.cs) muestra cómo configurar la seguridad en una aplicación .NET Core. A continuación, se muestra un ejemplo de cómo configurar la seguridad en tu proyecto:
