...
<LinkCard title="Explora la Clase CodeDesignPlusException" href="/libs/exceptions/codedesignplusexception" />
...
```csharp url="examples/CodeDesignPlus.Net.Exceptions.Sample/CodeDesignPlus.Net.Exceptions.Sample/Program.cs"
```
